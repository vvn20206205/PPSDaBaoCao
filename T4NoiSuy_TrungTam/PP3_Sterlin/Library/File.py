...
def INPUT():
    ...
    return fileMangX, fileMangY, DiemCanTinhGiaTri, GiaTriDiemTT
...
<!-- ************************************************************************************************************************************************************************************************* -->
    ...
    <div id="w70">
        ...
        <div class="package package1">
            ...
            <h5>- Kết quả tỷ hiệu:</h5>
            <p class="blue">{v.MaTranA}</p>
            <h5>- Tỷ sai phân (Sau khi lấy tỷ hiệu chia cho giai thừa):</h5>
            <p class="blue">{v.MaTran1}</p>
